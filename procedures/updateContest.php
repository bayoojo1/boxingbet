...
if($contests->updateContest($contestId, $a_wins, $a_wins_tko, $a_wins_split, $a_wins_unanimous, $a_r1_tko, $a_r2_tko, $a_r3_tko, $a_r4_tko, $a_r5_tko, $a_r6_tko, $a_r7_tko, $a_r8_tko, $a_r9_tko, $a_r10_tko, $a_r11_tko, $a_r12_tko, $draw, $b_wins, $b_wins_tko, $b_wins_split, $b_wins_unanimous, $b_r1_tko, $b_r2_tko, $b_r3_tko, $b_r4_tko, $b_r5_tko, $b_r6_tko, $b_r7_tko, $b_r8_tko, $b_r9_tko, $b_r10_tko, $b_r11_tko, $b_r12_tko, $event_date, $event_location)) {
    echo 'success';
}
